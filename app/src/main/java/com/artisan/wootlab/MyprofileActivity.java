...
public class MyprofileActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		setTitle("Profile");
		imageview1.setImageBitmap(FileUtil.decodeSampleBitmapFromPath(A.getString("pic", ""), 1024, 1024));
		Glide.with(getApplicationContext()).load(Uri.parse(A.getString("pic", ""))).into(imageview1);
		em.setText(A.getString("email", ""));
		pn.setText(A.getString("pn", ""));
		city.setText(A.getString("city", ""));
		us.setText(A.getString("username", ""));
		craft.setText(A.getString("Craft", ""));
		_Select(pn);
		_Select(city);
		_Select(us);
		_Select(craft);
